<div class="toolbar">
  ...
  <a href="/store?req=status" class="toolbar-icon toolbar-icon-store" title="Open Verge3D Asset Store"></a>
  ...
  <a href="javascript:void(0);" onclick=openSettingsDialog() class="toolbar-icon toolbar-icon-settings" title="Change App Manager Settings"></a>
