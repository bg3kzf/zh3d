...
(function() {
    ...
    var logicURL = params.logic ? params.logic : '__LOGIC__v3dApp/visual_logic.js'.replace('__LOGIC__', '');
    var sceneURL = params.load ? params.load : '__URL__v3dApp/app.gltf'.replace('__URL__', '');
    if (!sceneURL) {
